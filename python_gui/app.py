...
Uses system chromium installed via packages.txt.
...
st.markdown(
    '''<div class="main-header"><h1>\U0001f577 SEO Crawler</h1>
    <p>JS rendering · Jina AI embeddings · Semantic duplicates · Linking gaps</p></div>''',
    unsafe_allow_html=True,
)
...
with st.sidebar:
    ...
    use_reader = st.checkbox(
        "Use Jina Reader (cleaner text)", value=False,
